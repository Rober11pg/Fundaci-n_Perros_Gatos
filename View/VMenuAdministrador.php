...
<head>
    ...
    <script>
        function redirigir() {
            var select = document.getElementById('selectOperacion');
...
<body>
    <header>
        <nav>
            <select id="selectOperacion" onchange="redirigir()">
                <option value="">Selecciona una operación</option>
                <optgroup label="Ingresar">
                  <option value="../Controller/controlador.php?var=1">Ingresar Cliente</option>
                  <option value="../Controller/controlador.php?var=2">Ingresar Mascota</option>
                  <option value="../Controller/controlador.php?var=3">Ingresar Raza</option>
                  <option value="../Controller/controlador.php?var=4">Ingresar Especie</option>
                  <!--<option value="./Controller/controlador.php?var=5">Ingresar Adquisición</option>-->
                </optgroup>
                <optgroup label="Listar">
                  <option value="../Controller/controlador.php?var=6">Lista Mascota</option>
                  <option value="../Controller/controlador.php?var=8">Lista Cliente</option>
                  <option value="../Controller/controlador.php?var=16">Lista Especie</option>
                  <option value="../Controller/controlador.php?var=17">Lista Raza</option>
                </optgroup>
                <optgroup label="Reportes">
                  <option value="../Controller/controlador.php?var=10">Reporte Cliente</option>
                  <option value="../Controller/controlador.php?var=11">Reporte Mascota</option>
                  <option value="../Controller/controlador.php?var=12">Reporte Especie</option>
                  <option value="../Controller/controlador.php?var=13">Reporte Raza</option>
                  <option value="../Controller/controlador.php?var=14">Reporte Adquiere</option>
                  <option value="../Controller/controlador.php?var=15">Reporte Sexo y Cachorro</option>
                </optgroup>
              </select>
            
            <a href="./Controller/controlador.php?var=7">Busqueda Mascota</a>
            <a href="./Controller/controlador.php?var=9">Busqueda Cliente</a>

            <a href="#sobre-nosotros">Misión y Visión</a>
            <a href="#clientes">Nuestros Clientes</a>
            <a href="#servicios">Nuestros Servicios</a>

            <!--<a href="./Controller/controlador.php?var=1">Iniciar sesión</a>-->
