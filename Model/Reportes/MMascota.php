...
$pdf->Cell($cellWidthRazaID + $cellSpacing, 6, 'Raza ID', 1, 0, 'C');
...
foreach ($ListaMascota as $x)
{
    ...
    $pdf->Cell($cellWidthSexo + $cellSpacing, $f_grande, $x->getSexo(), 1, 0, 'C');
    $pdf->Cell($cellWidthRazaID + $cellSpacing, $f_grande, $x->getRazaID(), 1, 0, 'C');
